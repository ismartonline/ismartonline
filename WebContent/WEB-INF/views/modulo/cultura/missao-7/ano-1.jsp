		...
		<div class="row">
			<div class="col-sm-3">
				...
				<div class="row" id="acoes">
					...
					<!-- menu de categorias -->
					<div class="list-group ">
						<a href="<c:url value='/cultura/missao-7/ano-1/entrega' />"
			...
			<div class="col-sm-7">
				...
				<div class="row">
					<div class="col-sm-11 text-center wow fadeInUp content-center"
						data-wow-delay=".2s">
						<div class="thumbnail">
        						<iframe width="560" height="315" src="https://www.youtube.com/embed/GBOJKTMtgEk" frameborder="0" allowfullscreen></iframe>

							<div class="caption">
								<h4>Como criar uma boa apresentação</h4>
								<p>Missão 7</p>
