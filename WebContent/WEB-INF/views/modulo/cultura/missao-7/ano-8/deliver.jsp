            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <div class="row" id="acoes">
                        ...
                        <!-- menu de categorias -->
                        <div class="list-group ">
                            <a href="<c:url value='/cultura/missao-7/ano-8/entrega' />" class="list-group-item ">Entrega</a>
                    ...
                    <div class="row">
                        <div class="col-lg-7 text-center wow fadeInUp content-center"
                            ...
                            <div class="thumbnail">
                                ...
                                <form:form action="${pageContext.request.contextPath}/entrega-missao-7/submit" method="post" commandName="deliver" enctype="multipart/form-data">
