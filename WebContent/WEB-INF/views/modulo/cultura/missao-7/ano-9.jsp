			...
			<div class="col-sm-3">
				<div class="row" id="video">
					...
					<div class="list-group ">
						<a href="<c:url value='/cultura/missao-7/ano-9' />" class="list-group-item ">Missão 7</a>
					</div>
				</div>
				<div class="row" id="acoes">
					...
					<!-- menu de categorias -->
					<div class="list-group ">
						<a href="<c:url value='/cultura/missao-7/ano-9/entrega' />"
			...
			<div class="col-sm-9">
				...
				<div class="row">
					<div class="col-sm-9 text-center wow fadeInUp content-center"
						data-wow-delay=".2s">
						<div class="thumbnail">
							<iframe src="https://player.vimeo.com/video/142375277?title=0&byline=0&portrait=0" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
							...
							<div class="caption">
								...
								<div class="btn-group">
									<a href="${pageContext.request.contextPath}/resources/doc/missao7_9.pdf"
                                                                           class="btn btn-primary">
                                                                            <img src="${pageContext.request.contextPath}/resources/img/pdf-icon.png"
										 height="20px"
                                                                                 width="20px" />
									</a> 
									<a href="${pageContext.request.contextPath}/resources/doc/missao7_9.docx"
                                                                           class="btn btn-primary">
