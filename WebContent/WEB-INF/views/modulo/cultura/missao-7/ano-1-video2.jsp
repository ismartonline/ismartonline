				...
				<div class="col-sm-7">
					...
					<div class="row" >
						<div class="col-sm-11 text-center wow fadeInUp content-center" data-wow-delay=".2s" >
							<div class="thumbnail">
								<iframe width="560" height="315" src="https://www.youtube.com/embed/h-B3iJbb8z0" frameborder="0" allowfullscreen></iframe>
								<div class="caption">
									<h4>Como acontece um processo de criação</h4>
									<p>Missão 7</p>
									<div class="btn-group">
										
										<a href="<c:url value='/cultura/missao-7/ano-1' />" class="btn btn-primary">
											<< Anterior
										</a>
										
										<a href="<c:url value='/cultura/missao-7/ano-1/video-3' />" class="btn btn-primary">
											Próximo >>
										</a>
