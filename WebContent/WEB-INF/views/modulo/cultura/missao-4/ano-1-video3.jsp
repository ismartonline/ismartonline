				...
				<div class="col-sm-7">
					...
					<div class="row" >
						<div class="col-sm-11 text-center wow fadeInUp content-center" data-wow-delay=".2s" >
							<div class="thumbnail">
								<iframe width="560" height="315" src="https://www.youtube.com/embed/4z7gDsSKUmU" frameborder="0" allowfullscreen></iframe>
								<div class="caption">
									<h4>How To Change The World (a work in progress) | Kid President</h4>
									<p>Missão 4</p>
									<div class="btn-group">
