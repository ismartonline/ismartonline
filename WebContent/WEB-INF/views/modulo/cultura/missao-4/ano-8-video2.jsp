			...
			<div class="col-sm-3">
				<div class="row" id="video">
					...
					<div class="list-group ">
							...
							class="list-group-item ">Travessia - Vença seus obstáculos</a>
						<a href="<c:url value='/cultura/missao-4/ano-8/video-2' />"
							class="list-group-item ">Testes - Depoimento de bolsista do Ismart</a> <a
							href="<c:url value='/cultura/missao-4/ano-8/video-3' />"
							class="list-group-item ">Testes - Missão 4</a>
						</div>
				</div>
			...
			<div class="col-sm-9">
				...
				<div class="row">
					<div class="col-sm-9 text-center wow fadeInUp content-center"
						data-wow-delay=".2s">
						<div class="thumbnail">
							<iframe src="https://player.vimeo.com/video/130152254" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
							
							<div class="caption">
								<h4>Testes - Depoimento de bolsista do Ismart</h4>
								<p>Missão 4</p>
								<div class="btn-group">
									<a href="<c:url value='/cultura/missao-4/ano-8' />"
