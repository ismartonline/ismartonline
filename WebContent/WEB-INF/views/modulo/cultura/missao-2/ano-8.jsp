		...
		<div class="row">
			<div class="col-sm-3">
				<div class="row" id="video">
					...
					<div class="list-group ">
						<a href="<c:url value='/cultura/missao-2/ano-8' />"
							class="list-group-item ">Encontro com o Sábio - A Rã do Poço</a> <a
							href="<c:url value='/cultura/missao-2/ano-8/video-2' />"
				...
				<div class="row" id="acoes">
					...
					<!-- menu de categorias -->
					<div class="list-group ">
						<a href="<c:url value='/cultura/missao-2/ano-8/entrega' />"
			...
			<div class="col-sm-9">
				...
				<div class="row">
					<div class="col-sm-9 text-center wow fadeInUp content-center"
						data-wow-delay=".2s">
						<div class="thumbnail">
							<iframe src="https://player.vimeo.com/video/124248088"
								width="500" height="281" frameborder="0" webkitallowfullscreen
								mozallowfullscreen allowfullscreen></iframe>
							
							<div class="caption">
								<h4>Encontro com o Sábio - A Rã do Poço</h4>
								<p>Missão 2</p>
								<div class="btn-group">
								...
								<div class="btn-group ">
									<a
										href="${pageContext.request.contextPath}/resources/doc/missao2_8.pdf"
										class="btn btn-primary"> <img
										src="${pageContext.request.contextPath}/resources/img/pdf-icon.png"
										height="20px" width="20px" />
									</a> <a
										href="${pageContext.request.contextPath}/resources/doc/missao2_8.doc"
										class="btn btn-primary"> <img
