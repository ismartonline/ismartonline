				...
				<div class="col-sm-3">
					<div class="row" id="video">
						...
						<div class="list-group ">
							...
							class="list-group-item ">Como ter foco: 2 coisas que você precisa definir na sua vida</a>
							<a href="<c:url value='/cultura/missao-3/ano-1/video-2' />"
							class="list-group-item ">Defining a Problem: Crash Course Kids #18.1</a>
							<a href="<c:url value='/cultura/missao-3/ano-1/video-3' />"
							class="list-group-item ">DIY Toolkit | Problem Definition</a>
							<a href="<c:url value='/cultura/missao-3/ano-1/video-4' />"
					...
					<div class="row" id="acoes">
							...
							<!-- menu de categorias -->
							<div class="list-group ">
								<a href="<c:url value='/cultura/missao-3/ano-1/entrega' />" class="list-group-item ">Entrega</a>
				...
				<div class="col-sm-7">
					...
					<div class="row" >
						<div class="col-sm-11 text-center wow fadeInUp content-center" data-wow-delay=".2s" >
							<div class="thumbnail">
								<iframe width="560" height="315" src="https://www.youtube.com/embed/OyTEfLaRn98" frameborder="0" allowfullscreen></iframe>
								<div class="caption">
									<h4>Defining a Problem: Crash Course Kids #18.1</h4>
									<p>Missão 3</p>
									<div class="btn-group">
										
										<a href="<c:url value='/cultura/missao-3/ano-1' />" class="btn btn-primary">
											<< Anterior
										</a>
										
										<a href="<c:url value='/cultura/missao-3/ano-1/video-3' />" class="btn btn-primary">
											Próximo >>
										</a>
