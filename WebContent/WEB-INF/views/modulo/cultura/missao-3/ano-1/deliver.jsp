		...
		<div class="row">
			<div class="col-sm-3">
				...
				<div class="row" id="acoes">
					...
					<!-- menu de categorias -->
					<div class="list-group ">
						<a href="<c:url value='/cultura/missao-3/ano-1/entrega' />" class="list-group-item ">Entrega</a> <a href="#"
				...
				<div class="row">
					<div class="col-lg-7 text-center wow fadeInUp content-center"
						...
						<div class="thumbnail">
							...
							<form:form action="${pageContext.request.contextPath}/entrega-missao-3/submit" method="post" commandName="deliver" enctype="multipart/form-data">
