				...
				<div class="col-sm-7">
					...
					<div class="row" >
						<div class="col-sm-11 text-center wow fadeInUp content-center" data-wow-delay=".2s" >
							<div class="thumbnail">
								<iframe width="560" height="315" src="https://www.youtube.com/embed/o4dddmOpQ5s" frameborder="0" allowfullscreen></iframe>
								<div class="caption">
									<h4>DIY Toolkit | Problem Definition</h4>
									<p>Missão 3</p>
									<div class="btn-group">
										...
										<a href="<c:url value='/cultura/missao-3/ano-1/video-4' />" class="btn btn-primary">
											Próximo >>
										</a>
