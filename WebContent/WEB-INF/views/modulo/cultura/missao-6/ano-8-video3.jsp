			...
			<div class="col-sm-9">
				...
				<div class="row">
					<div class="col-sm-9 text-center wow fadeInUp content-center"
						data-wow-delay=".2s">
						<div class="thumbnail">
							<iframe src="https://player.vimeo.com/video/135293388?title=0&byline=0&portrait=0" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
							
							<div class="caption">
								<h4>Crise - Missão 6</h4>
								<p>Missão 6</p>
								<div class="btn-group">
