				...
				<div class="row">
					<div class="col-lg-7 text-center wow fadeInUp content-center"
						...
						<div class="thumbnail">
							...
							<form:form action="${pageContext.request.contextPath}/entrega-missao-6/submit" method="post" commandName="deliver" enctype="multipart/form-data">
