				...
				<div class="col-sm-9">
					...
					<div class="row" >
						<div class="col-sm-9 text-center wow fadeInUp content-center" data-wow-delay=".2s" >
							<div class="thumbnail">
								<iframe src="https://player.vimeo.com/video/91516394" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
								<div class="caption">
									<h4>Chamado - depoimento bolsista do ismart</h4>
									<p>Missão 1</p>
									<div class="btn-group">
										<a href="<c:url value='/cultura/missao/ano-8' />" class="btn btn-primary">
											<< Anterior
										</a>
										<a href="<c:url value='/cultura/missao/ano-8/video-3' />" class="btn btn-primary">
											Próximo >>
										</a>
									</div>
									<div class="btn-group ">
										<a href="${pageContext.request.contextPath}/resources/doc/missao1_8.pdf"  class="btn btn-primary">
											<img src="${pageContext.request.contextPath}/resources/img/pdf-icon.png" height="20px" width="20px"/>
										</a>
										<a href="${pageContext.request.contextPath}/resources/doc/missao1_8.docx"  class="btn btn-primary">
